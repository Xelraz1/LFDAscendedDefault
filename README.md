<table>
  <tr>
    <td><img src="https://github.com/user-attachments/assets/34ccdb7c-313a-46a6-a620-2f08f25ba184" width="400"></td>
    <td><img src="https://github.com/user-attachments/assets/2f6ceb75-80fd-40fb-8101-e169fc0ef1b1" width="400"></td>
  </tr>
</table>
...
2. Extract the ZIP
3. Copy the folder `LFDAscendedDefault` into:

   `World of Warcraft/Interface/AddOns/`

4. Your final folder should look like this:

   `World of Warcraft/Interface/AddOns/LFDAscendedDefault/`

Inside that folder you should have:
- `LFDAscendedDefault.toc`
